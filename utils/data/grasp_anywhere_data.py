...
class GraspAnywhereDataset(LanguageGraspDatasetBase):
    ...
    def __init__(self, file_path, ds_rotate=0, **kwargs):
        ...
        """
        # Consume split_file before forwarding kwargs to the parent, which
        # does not accept it (see notes/paper_vs_code.md #4).
        split_file = kwargs.pop("split_file", None)
        ...
        if split_file is None:
            split_file = 'split/grasp-anything++/test/seen.obj' if kwargs["seen"] else 'split/grasp-anything++/test/unseen.obj'
